 ...
 * Here, that's the SneakersController object.
 * @class
 * @classdesc The SneakersController class represents the application controller.
 * @see {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/this}
...
export class SneakersController {
    /**
    * Creates an object representing the sneakers controller.
    * 
    * @constructor
    * @param {Object} model - The model the controller interacts with.
    * @param {Object} view - The view the controller interatcs with.
    * @returns {SneakersController} The object representing the sneakers controller.
    */
    constructor(model, view) {
        ...
        this.view.sneakersForm.addEventListener('submit', this.handleFormSubmit);

    }

    /**
    * Handles the change event generated by a select.
    * 
    ...
    */
    handleSelectChange = (event) => {
        ...
        //2. UPDATE VIEW (selectsDiv + sneakers -------------------------------    
        ...
        //2.2. Update the sneakers 
        this.view.renderSneakers();
    }

    /**
     * Handles the form submit event.
     * 
     * @param {Event} event - The event object representing the form submit
     */
